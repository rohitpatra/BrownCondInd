...
//  File "mvnnorm.cpp" from "energy" package version 1.7.5 (https://cran.r-project.org/src/contrib/Archive/energy/)

#include <Rcpp.h>
using namespace Rcpp;

double   mvnEstatLocal(NumericMatrix y);
double   sumdistLocal(NumericMatrix x);
...
double mvnEstatLocal(NumericMatrix y)  {
  ...
  meanyy = sumdistLocal(y);  // computing third mean
